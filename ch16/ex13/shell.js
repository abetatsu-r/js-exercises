    ...
    case ">": // RedirCmd
      {
        ...
        const redirectedStdout = fs.createWriteStream(cmd.file);
        runcmd(cmd.cmd, stdin, redirectedStdout);
      }
      break;
    ...
    case "<": // RedirCmd
      {
        ...
        const redirectedStdin = fs.createReadStream(cmd.file);
        runcmd(cmd.cmd, stdinFile, redirectedStdin);
      }
      break;
